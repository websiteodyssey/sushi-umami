      ...
      <section className="py-12 md:py-20 lg:py-28 bg-luxury-cream">
        <div className="section-padding">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-lg text-luxury-gray-dark font-body">{t("contact.text")}</p>
            <div className="h-px bg-luxury-gold mx-auto mt-6 w-20" />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-5xl mx-auto items-stretch">
            <div className="luxury-card p-8 flex flex-col gap-6 font-body">
              ...
              <a
                ...
                className="mt-auto inline-block text-center border border-luxury-gold text-luxury-gold hover:bg-luxury-gold hover:text-luxury-black transition-colors uppercase text-sm tracking-luxury px-6 py-3"
              >
                {t("contact.mapCta")}
              </a>
            </div>

            <div className="min-h-[400px] luxury-card overflow-hidden">
              <iframe
                title="map"
                src={mapEmbedSrc}
